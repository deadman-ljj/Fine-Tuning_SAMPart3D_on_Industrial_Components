...
class Trainer(TrainerBase):
    ...
    def eval(self):
        ...
        for scale in self.val_scales_list:
            ...
            total_cluster_time += cluster_duration
            self.logger.info(f"HDBSCAN@scale={scale} took {cluster_duration:.3f} seconds")
            #聚类结束
        ...
        self.logger.info(f"Total HDBSCAN clustering time: {total_cluster_time:.3f} seconds")      
